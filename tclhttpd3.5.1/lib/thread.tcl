...
proc Thread_Start {} {
    ...
    puts "MH: 3; Thread_Start; id=$id"

    
    Thread_Send $id {package require md5 1.0}
      # MH: czy to pomoze ??? TAK !!!
      # jest jakis problem z pakietem md5 !?!?!!?!?
